...
#include <queue>
using namespace std;
#define MAX 10005 //como maximo 10005 de vertices
...
vector< Node > ady[ MAX ]; //lista de adyacencia acorde al tamaño definido de memoria
int distancia[ MAX ];      //distancia entre el vertice inicial al siguiente
bool visitado[ MAX ];      //que vertices se han visitado
priority_queue< Node , vector<Node> , cmp > Q; //definir la cola de prioridad, para saber el menor valor que este a tope
...
int main(){
    ...
    printf("Ingresa el numero de vertices y de aristas");
    scanf("%d %d" , &V , &E );
    while( E-- ){
